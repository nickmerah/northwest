...
<head>
    ...
    <title>Final Clearance - Delta State Polytechnic, Ogwashi-Uku</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="watermarked-page">
        ...
        <div class="content">
            <div align="center"> <br>
                ...
                <br><br>
                <h1><span class="large-text">{{ $schoolName->schoolname }}</span></h1>
                    ...
                    <div class="container mt-4">
                        <table class="table table-bordered  ">
                            <tbody>
                                ...
                                <tr>
                                    <th colspan="2">FEE DETAILS - {{ $student?->programme->aprogramme_name }} {{ strtoupper($packName) }}</th>
                                </tr>
                                @php
