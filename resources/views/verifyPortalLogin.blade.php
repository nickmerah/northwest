    ...
    <div class="container">
        <div class="login-container">
            ...
            <div class="alert alert-info text-center" role="alert">
                Enter your Matriculation number and Verify to Proceed.
            </div>
            @if (session('error'))
            ...
            <form method="POST" action="{{ route('portalverify') }}">
                @csrf
                <div class="form-group">
                    <label for="matno"><strong>Matriculation Number</strong></label>
                    <input type="text"
                        class="form-control @error('matno') is-invalid @enderror"
                        id="matno"
                        name="matno"
                        value="{{ old('matno') }}"
                        required
                ...
                <button type="submit" class="btn btn-orange btn-block">Verify</button>
            </form>
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="register-link">
                    <a href="{{ url('/portallogin') }}"> Login >> </a>
                </div>
            </div>
